...
while True:
    word = input('Прогрвмма совершит для Вас поиск доступных вакансий с сайта hh.ru, Вы можете выбрать одну из' 
    'нижеперечисленных возможностей сортировки поиска:\n  1  -  чтобы получить список всех компаний и количество'
