...
while True:
    word = input('Программа совершит для Вас поиск доступных вакансий с сайта hh.ru, Вы можете выбрать одну из'
                 ' ниже перечисленных возможностей сортировки поиска:\n  1  -  чтобы получить список всех компаний'
                 ' и количество вакансий у каждой компании. \n  2  -  чтобы получить список всех вакансий с '
                 'указанием названия компании, названия вакансии, зарплаты и ссылки на вакансию.\n  3  -  '
                 'чтобы получить среднюю зарплату по вакансиям.\n  4  -  чтобы получить список всех вакансий, у'
                 ' которых зарплата выше средней по всем вакансиям.\n  5  -  чтобы получить список всех вакансий, '
